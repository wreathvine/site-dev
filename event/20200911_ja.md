...
<table class="eventOverviewTable">
  <tbody>
    <tr>
      ...
      <a class="eventCalenderLink" href="../asset/event_ics/Exastro-20200911-1400-1600.ics" download="システムライフサイクルをデジタル化するExastro活用術" target="_blank"><i class="far fa-calendar-alt"></i> .ics ダウンロード</a>--></td>
    </tr>
    <tr>
      <th>会場</th>
      <td>Webセミナー
...
<div id="eventDescription" class="eventBlock">
  ...
  <div class="eventBlockBody">
    ...
    <div class="eventDescriptionSub">
      <a class="leafletLink" href="../asset/event_img/20200911_leaflet.pdf" title="システムライフサイクルをデジタル化するExastro活用術" target="_blank">
        <img src="../asset/event_img/20200911_leaflet.jpg" alt="システムライフサイクルをデジタル化するExastro活用術"><br>
        Leaflet（PDF）
      </a>
    </div>
  </div>
