...
function viewDocuments( ducumentsJsonUrl ) {
		...
		if ( $body.is('.en') || $body.is('.lang-en') ) {
			language = 'en';
		} else if ( $body.is('.ja') || $body.is('.lang-ja') ) {
			language = 'ja';
		} else {
			language = undefined;
		}
    ...
    $.ajax({
      ...
      $viewDocuments.each( function() {
        ...
        if ( documentName in documents ) {
          ...
          switch( documentType ) {
            case 'none':
              viewHTML += '<img src="https://exastro-suite.github.io/docs/asset/img/under_construction.jpg" alt="Under Construction"></div>';
              $viewDocument.prepend( viewHTML );
              break;
            case 'pdf':
            case 'slide':
              if( $viewDocument.is('.wide') ){
                viewHTML += '<img src="https://exastro-suite.github.io/docs/asset/img/view_' + documentType + '_wide.jpg" alt="View ' + documentType + '">';
              } else {
                viewHTML += '<img src="https://exastro-suite.github.io/docs/asset/img/view_' + documentType + '.jpg" alt="View ' + documentType + '">';
              }
